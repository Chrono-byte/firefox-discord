	...
	if ('undefined' == typeof browser || Object.getPrototypeOf(browser) !== Object.prototype) {
		...
		a.exports = (a => {
			const b = {
				...
				devtools: {inspectedWindow: {eval: {minArgs: 1, maxArgs: 2, singleCallbackArg: !1}}, panels: {create: {minArgs: 3, maxArgs: 3, singleCallbackArg: !0}}},
				downloads: {
			...
			const m = new c(a =>
				...
				p = {
					runtime: {onMessage: k(m), onMessageExternal: k(m), sendMessage: o.bind(null, 'sendMessage', {minArgs: 1, maxArgs: 3})},
